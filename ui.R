            ...
            tabItem(tabName = "model",
                     tabBox(id ="t1", width = 12,
                           tabPanel("Modeling Info", icon = icon("address-card"),
                                    ...
                                    fluidPage(a(href = "https://www.geeksforgeeks.org/advantages-and-disadvantages-of-logistic-regression/", h3(strong("Logistic Regression"))),
                                              p("Logistic regression is a classification algorithm used to find the probability of event success and event failure. It is used when the dependent variable is binary(0/1, True/False, Yes/No) in nature. It supports categorizing data into discrete classes by studying the relationship from a given set of labelled data."),
                                              box(h4(strong("Advantages:")),
                                                  p("1. Logistic regression is easier to implement, interpret, and very efficient to train."),
                                                  p("2. It makes no assumptions about distributions of classes in feature space."),
                                                  p("3. It can easily extend to multiple classes(multinomial regression) and a natural probabilistic view of class predictions.")),
                                              box(h4(strong("Advantages:")),
                                                  p("1. If the number of observations is lesser than the number of features, Logistic Regression should not be used, otherwise, it may lead to overfitting."),
                                                  p("2. The major limitation of Logistic Regression is the assumption of linearity between the dependent variable and the independent variables."))),
